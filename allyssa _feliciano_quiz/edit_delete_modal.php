    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">Edit Record</h4></center>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="edit" class="btn btn-success" style="color: black; background-color: orange; border: none"> Update</a>
			</form>
            </div>
...
<div class="modal fade" id="delete_<?php echo $row->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                <a href="delete.php?id=<?php echo $row->id; ?>" class="btn btn-danger" style="border: none; background-color: orange; color: black"> Yes</a>
            </div>
